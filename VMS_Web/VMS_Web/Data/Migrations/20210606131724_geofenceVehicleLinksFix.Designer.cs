...
namespace VMS_Web.Data.Migrations
{
    ...
    [Migration("20210606131724_geofenceVehicleLinksFix")]
    partial class geofenceVehicleLinksFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.CompanySettings", b =>
                {
                    b.Property<int>("CompanyId")
                        .HasColumnType("integer")
                        .HasColumnName("company_id");
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.Employee", b =>
                {
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.Geofence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.GeofenceVehicleLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.Role", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.Vehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.VehicleData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.VehicleDriverLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.WorkTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.WorkTaskComment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.WorkTaskStatus", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.ChatMessage", b =>
                {
                    b.HasOne("VMS_Web.Data.DatabaseModels.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VMS_Web.Data.DatabaseModels.Employee", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("VMS_Web.Data.DatabaseModels.Employee", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.Employee", b =>
                {
                    ...
                    b.HasOne("VMS_Web.Data.DatabaseModels.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.GeofenceVehicleLink", b =>
                {
                    b.HasOne("VMS_Web.Data.DatabaseModels.Geofence", "Geofence")
                        .WithMany()
                        .HasForeignKey("GeofenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VMS_Web.Data.DatabaseModels.Vehicle", "Vehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.Notification", b =>
                {
                    b.HasOne("VMS_Web.Data.DatabaseModels.Employee", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.VehicleDriverLink", b =>
                {
                    b.HasOne("VMS_Web.Data.DatabaseModels.Employee", "Driver")
                        .WithMany()
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.WorkTask", b =>
                {
                    ...
                    b.HasOne("VMS_Web.Data.DatabaseModels.Employee", "Operator")
                        .WithMany()
                        .HasForeignKey("OperatorId");

                    b.HasOne("VMS_Web.Data.DatabaseModels.WorkTaskStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("VMS_Web.Data.DatabaseModels.WorkTaskComment", b =>
                {
                    b.HasOne("VMS_Web.Data.DatabaseModels.Employee", "Author")
                        .WithMany()
                    ...
                    b.HasOne("VMS_Web.Data.DatabaseModels.WorkTask", "Task")
                        .WithMany()
